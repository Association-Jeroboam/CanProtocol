...
enum CanProtocolServoID {
    ...
    CAN_PROTOCOL_SERVO_RAKE_LEFT_TOP,
    CAN_PROTOCOL_SERVO_RAKE_LEFT_BOTTOM,
    CAN_PROTOCOL_SERVO_RAKE_RIGHT_TOP,
    CAN_PROTOCOL_SERVO_RAKE_RIGHT_BOTTOM,
    CAN_PROTOCOL_SERVO_PUSH_ARM_LEFT,
    CAN_PROTOCOL_SERVO_PUSH_ARM_RIGHT,
    CAN_PROTOCOL_SERVO_MEASURE_FORK,
    CAN_PROTOCOL_SERVO_PLIERS_INCLINATION,
    CAN_PROTOCOL_SERVO_PLIERS,
};
