...
enum CanProtocolServoID {
    ...
    CAN_PROTOCOL_SERVO_LIFT_LEFT          = 14,
    CAN_PROTOCOL_SERVO_LIFT_RIGHT         = 15,
    CAN_PROTOCOL_SERVO_ROLLER_LEFT        = 16,
    CAN_PROTOCOL_SERVO_ROLLER_RIGHT       = 17,
    CAN_PROTOCOL_SERVO_FINGER_LEFT        = 18,
    CAN_PROTOCOL_SERVO_FINGER_RIGHT       = 19,
};
...
enum CanProtocolPIDID{
    ...
    CAN_PROTOCOL_LINEAR_SPEED_PID_ID,
    CAN_PROTOCOL_ANGULAR_SPEED_PID_ID,
